"""This file contains helper functions for the experiments, notably to interface the simulation with the CIRCE algorithm"""
...
## This function generates the observation for the simulation
...
## This function generates timesteps where the questions can be asked
...
## Helper function to transform a state to an observation where the predicate can be computed
...
# This function automatically generates many timesteps where the question can be asked
...
## This function tests if two clauses should be considered equal
def match_clauses(c1, c2):
  return c1[0] == c2[0] and c1[1] == c2[1] and abs(c1[2] - c2[2])/abs(c1[2]) < .35

## This function removes duplicate clause from predicates
...
## This function evaluates the precision, recall and F1 score between a true and predicted predicate
...
## This function generates the expected predicate for each question
